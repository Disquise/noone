    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "{0} ElkaHack punches deferred. ({1} Failed)".format(self.counter[0], self.counter[1])
...
def usage():
    print
    print '-----------------------------------------------------------------------------------------------------------'
    print ' USAGE: ./elkahack.py <url> [OPTIONS]'
    print
    print ' OPTIONS:'
